...
import { Box, Dumbbell, Flower2, Home, Plug, Shirt, LucideIcon} from "lucide-react"
                    ...
                    <div className="grid gap-2">
                        ...
                        {sellMethods.map((sellMethod) => (
                            <div className="flex items-center space-x-2">
                                ...
                                <Label className='text-sm text-muted-foreground' htmlFor={sellMethod.id}>{sellMethod.label}</Label>
                            </div>
                        ))}
                    </div>
                <DialogFooter>
